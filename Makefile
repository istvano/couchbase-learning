...
rest/rbac/check-perms: ##@rest Check DB_USER permission against list
	$(CURL) $(CURL_OPTS) $(API_ENDPOINT)/pools/default/checkPermissions \
		-u $(DB_USER):$$COUCHBASE_ADMINISTRATOR_PASSWORD \
		-d '$(PERMISSION)' | jq
